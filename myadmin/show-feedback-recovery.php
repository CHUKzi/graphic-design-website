...
if(isset($_POST['submit2']))
  {
	...
	$sender='Admin';
	$history_type=',s feedback is Recovery';
	...
	$sql="UPDATE cl_feedback SET is_delete=(:is_delete) WHERE id=(:idedit)";

	$query = $dbh->prepare($sql);
	$query-> bindParam(':is_delete', $is_delete, PDO::PARAM_STR);
	$query-> bindParam(':idedit', $idedit, PDO::PARAM_STR);
    $query->execute();
    header('Location: clint-feedback.php?result=Recovery-Successfully..');
}    
?>
<!doctype html>
...
<body>
<?php
		$sql = "SELECT * from cl_feedback where id = :emailid";
		$query = $dbh -> prepare($sql);
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title"><font color="#FF7355"><b> <?php echo htmlentities($result->name);?></b></font></h3>
						<div class="row">
							<div class="col-md-12">
...
<center><img src="../assets/img/icon/satisfaction/<?php echo htmlentities($result->satisfaction);?>.png"></center>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		...
		<button class="btn btn-success" name="submit2" type="submit"onclick="return confirm('Are you sure you want to recovery this FEEDBACK');"> <i class="fa fa-undo"></i>&nbsp;Recovery This FEEDBACK</button>
	</div>
</div>
</form>
<a href="clint-feedback-recovery.php"><button class="btn btn-brand"><i class="fa fa-mail-reply"></i>&nbsp;Back To Delete list</button></a>
