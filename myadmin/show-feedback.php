...
if(isset($_GET['feedback']))
	{
		...
		$sql="UPDATE cl_feedback SET is_hide='$is_hide' WHERE id='$editid'";
...
if(isset($_POST['submit2']))
  {
	...
	$sender='Admin';
	$history_type=',s feedback is deleted';
    ...
    $query->execute();
    header('Location: clint-feedback.php?result=Deleted Successfully..');
}    
?>
<!doctype html>
...
<a href="clint-feedback.php"><button class="btn btn-brand"><i class="fa fa-mail-reply"></i>&nbsp;Back To Mail list</button></a>
