...
$sql="UPDATE notification SET feedback='$feedback' WHERE id='1'";
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    {               ?>
										...
										<tr>
                                            ...
                                            <td>
											<a href="show-feedback.php?feedback=<?php echo $result->id;?>">&nbsp; <i class="fa fa-eye"></i>&nbsp;view more</a>
											</td>
											<td>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="clint-feedback.php"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
